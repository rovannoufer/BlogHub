    ...
    return(
        <>
          <div className="flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center">
              ...
              <div className="flx flex-col justify-between py-2 w-full min-w-[300px]">
                  <div>
                  ...
                  <div className="flex-gap-6 mt-3"> 
                       ...
                       onClick={() => setShowStat(preValue => !preValue)}
                       > Stats </button>
...
export const ManageDraftBlogPost = ( { blog} ) =>{
    ...
    return (
        ...
        <div className="flex gap-5 lg:gap-10 border-b pb-6 mb-6 border-grey">
...
const deleteBlog = (blog, access_token, target) =>{
    ...
    axios.post(serverUrl+"/delete-blog",{
        blog_id},{
            headers:{
